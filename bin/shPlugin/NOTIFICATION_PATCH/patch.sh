...
patch="python3 $dir/bin/shPlugin/NOTIFICATION_PATCH/patch_EXPVersion.py"
JARDIR="$dir/jar_temp"
...
Patch_Framework () {
    ...
    jar_util d 'oplus-services.jar' fw 0 10

    $patch $dir/jar_temp/oplus-services.jar.out
    
    jar_util a 'oplus-services.jar' fw 0 10
