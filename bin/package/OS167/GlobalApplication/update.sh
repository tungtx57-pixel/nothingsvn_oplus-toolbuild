...
aria2c -q -d "$work_dir/bin/package/OS167/GlobalApplication/privapp/OppoGallery2/" -o OppoGallery2.apk https://github.com/tiencv2006/nothingsvn_oplus-toolbuild/releases/download/oplus/OppoGallery161.apk && echo "[INFO] - Get File Successfully"
